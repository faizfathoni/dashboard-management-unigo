    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4 border-b border-slate-200 dark:border-slate-800 pb-3">
          ...
          <button
            onClick={onClose}
            className="text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 rounded-md p-1 hover:bg-slate-100 dark:hover:bg-slate-800/60 transition-all cursor-pointer outline-none focus:ring-2 focus:ring-violet-500/40"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
